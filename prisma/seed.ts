...
const BLOB = (file: string) =>
  `https://zy8lv1ozr05tdbmz.public.blob.vercel-storage.com/product-images/${file}`;
...
async function main() {
  ...
  const modelTracer9    = await prisma.model.upsert({ where: { slug: "yamaha-tracer-9" },    update: {}, create: { slug: "yamaha-tracer-9",    name: "Tracer 9",  brandId: yamaha.id } });
  ...
  const modelAmarok     = await prisma.model.upsert({ where: { slug: "volkswagen-amarok" },   update: {}, create: { slug: "volkswagen-amarok",           name: "Amarok",        brandId: volkswagen.id } });
  ...
  const carProducts = [
    { slug: "togg-t10x-uzun-menzil-2023", name: "Togg T10X Uzun Menzil 2023", year: 2023, trimName: "Uzun Menzil",
      imageUrl: BLOB("togg-t10x-2023.jpg"), modelId: modelT10X.id, brandId: togg.id,
    ...
    { slug: "togg-t10x-uzun-menzil-2024", name: "Togg T10X Uzun Menzil 2024", year: 2024, trimName: "Uzun Menzil",
      imageUrl: BLOB("togg-t10x-2024.jpg"), modelId: modelT10X.id, brandId: togg.id,
      attributes: { fuel_type: "EV", segment: "C", body_type: "suv", ev_range_km: 523, power_hp: 200,
        battery_kwh: 88.5, torque_nm: 380, drivetrain: "AWD", transmission: "otomatik",
        top_speed_kmh: 210, zero_to_100: 4.8, boot_l: 515, weight_kg: 2082 } },
    { slug: "togg-t10f-standart-menzil-2024", name: "Togg T10F Standart Menzil 2024", year: 2024, trimName: "Standart Menzil",
      imageUrl: BLOB("togg-t10f-2024.jpg"), modelId: modelT10F.id, brandId: togg.id,
    ...
    { slug: "tesla-model-y-long-range-awd-2023", name: "Tesla Model Y Long Range AWD 2023", year: 2023, trimName: "Long Range AWD",
      imageUrl: BLOB("tesla-model-y-2023.jpg"), modelId: modelModelY.id, brandId: tesla.id,
    ...
    { slug: "tesla-model-y-long-range-rwd-2024", name: "Tesla Model Y Long Range RWD 2024", year: 2024, trimName: "Long Range RWD",
      imageUrl: BLOB("tesla-model-y-2024.jpg"), modelId: modelModelY.id, brandId: tesla.id,
      attributes: { fuel_type: "EV", segment: "D", body_type: "suv", ev_range_km: 533, power_hp: 299,
    ...
    { slug: "fiat-egea-urban-2020", name: "Fiat Egea Urban 2020", year: 2020, trimName: "Urban",
      imageUrl: BLOB("fiat-egea-sedan-2020.jpg"), modelId: modelEgea.id, brandId: fiat.id,
    ...
    { slug: "fiat-egea-urban-2022", name: "Fiat Egea Urban 2022", year: 2022, trimName: "Urban",
      imageUrl: BLOB("fiat-egea-sedan-2022.jpg"), modelId: modelEgea.id, brandId: fiat.id,
      attributes: { fuel_type: "GASOLINE", segment: "C", body_type: "sedan", engine_cc: 1368, power_hp: 95,
        torque_nm: 200, drivetrain: "FWD", transmission: "manuel",
        top_speed_kmh: 190, zero_to_100: 12.5, boot_l: 520, weight_kg: 1215, tank_l: 48 } },
    { slug: "fiat-egea-lounge-2024", name: "Fiat Egea Lounge 2024", year: 2024, trimName: "Lounge",
      imageUrl: BLOB("fiat-egea-sedan-2024.jpg"), modelId: modelEgea.id, brandId: fiat.id,
      attributes: { fuel_type: "GASOLINE", segment: "C", body_type: "sedan", engine_cc: 1368, power_hp: 95,
        torque_nm: 200, drivetrain: "FWD", transmission: "manuel",
        top_speed_kmh: 190, zero_to_100: 12.5, boot_l: 520, weight_kg: 1215, tank_l: 48 } },
    { slug: "renault-clio-touch-2021", name: "Renault Clio Touch 2021", year: 2021, trimName: "Touch",
      imageUrl: BLOB("renault-clio-2021.jpg"), modelId: modelClio.id, brandId: renault.id,
    ...
    { slug: "renault-clio-techno-2023", name: "Renault Clio Techno 2023", year: 2023, trimName: "Techno",
      imageUrl: BLOB("renault-clio-2023.jpg"), modelId: modelClio.id, brandId: renault.id,
      attributes: { fuel_type: "GASOLINE", segment: "B", body_type: "hatchback", engine_cc: 999, power_hp: 90,
        torque_nm: 160, drivetrain: "FWD", transmission: "manuel",
        top_speed_kmh: 183, zero_to_100: 12.8, boot_l: 391, weight_kg: 1095, tank_l: 40 } },
    { slug: "renault-clio-hybrid-2023", name: "Renault Clio Hybrid 2023", year: 2023, trimName: "E-Tech",
      imageUrl: BLOB("renault-clio-hybrid-2023.jpg"), modelId: modelClio.id, brandId: renault.id,
    ...
    { slug: "dacia-duster-comfort-2021", name: "Dacia Duster Comfort 2021", year: 2021, trimName: "Comfort",
      imageUrl: BLOB("dacia-duster-2021.jpg"), modelId: modelDuster.id, brandId: dacia.id,
    ...
    { slug: "dacia-duster-extreme-2024", name: "Dacia Duster Extreme 2024", year: 2024, trimName: "Extreme",
      imageUrl: BLOB("dacia-duster-2024.png"), modelId: modelDuster.id, brandId: dacia.id,
  ...
  const motoProducts = [
    { slug: "honda-cb500f-2023", name: "Honda CB500F 2023", year: 2023, trimName: null,
      imageUrl: BLOB("honda-cb500f-2023.jpg"), modelId: modelCB500F.id, brandId: honda.id,
    ...
    { slug: "honda-nc750x-dct-2023", name: "Honda NC750X DCT 2023", year: 2023, trimName: "DCT",
      imageUrl: BLOB("honda-nc750x-2023.jpg"), modelId: modelNC750X.id, brandId: honda.id,
    ...
    { slug: "yamaha-mt-07-2023", name: "Yamaha MT-07 2023", year: 2023, trimName: null,
      imageUrl: BLOB("yamaha-mt07-2023.jpg"), modelId: modelMT07.id, brandId: yamaha.id,
    ...
    { slug: "yamaha-tracer-9-gt-2023", name: "Yamaha Tracer 9 GT+ 2023", year: 2023, trimName: "GT+",
      imageUrl: BLOB("yamaha-tracer-9-gt-2023.jpg"), modelId: modelTracer9.id, brandId: yamaha.id,
    ...
    { slug: "kawasaki-z650-2023", name: "Kawasaki Z650 2023", year: 2023, trimName: null,
      imageUrl: BLOB("kawasaki-z650-2023.jpg"), modelId: modelZ650.id, brandId: kawasaki.id,
    ...
    { slug: "kawasaki-ninja-400-2023", name: "Kawasaki Ninja 400 2023", year: 2023, trimName: null,
      imageUrl: BLOB("kawasaki-ninja-400-2023.jpg"),
    ...
    { slug: "zero-motorcycles-sr-s-premium-2024", name: "Zero Motorcycles SR/S Premium 2024", year: 2024, trimName: "Premium",
  ...
  const escooterProducts = [
    { slug: "xiaomi-mi-electric-scooter-4-pro-2023", name: "Xiaomi Mi Electric Scooter 4 Pro 2023", year: 2023, trimName: null,
      imageUrl: BLOB("xiaomi-mi-4-pro-2023.webp"), modelId: modelXiaomi4Pro.id, brandId: xiaomi.id,
  ...
  const karavanProducts = [
    { slug: "knaus-sky-i-2023", name: "Knaus Sky-i 2023", year: 2023, trimName: null,
      ...
      attributes: { karavan_type: "motorlu", berth: 4, length_cm: 744, width_cm: 234,
        total_weight_kg: 3500, has_bathroom: true, has_shower: true, has_kitchen: true, has_ac: true,
        heating_type: "gazli", water_tank_l: 100, waste_water_tank_l: 95,
        height_cm: 200, exterior_height_cm: 294, empty_weight_kg: 2985,
        engine_cc: 2287, power_hp: 130, transmission: "Manuel" } },
  ...
  const kamyonetProducts = [
    { slug: "ford-ranger-wildtrak-2023", name: "Ford Ranger Wildtrak 2023", year: 2023, trimName: "Wildtrak",
      imageUrl: BLOB("ford-ranger-2023.jpg"), modelId: modelRanger.id, brandId: ford.id,
    ...
    { slug: "ford-ranger-raptor-2024", name: "Ford Ranger Raptor 2024", year: 2024, trimName: "Raptor",
      imageUrl: BLOB("ford-ranger-2024.jpg"), modelId: modelRanger.id, brandId: ford.id,
    ...
    { slug: "ford-transit-custom-trend-2023", name: "Ford Transit Custom Trend 2023", year: 2023, trimName: "Trend",
      imageUrl: BLOB("ford-transit-custom-2023.jpg"), modelId: modelTransit.id, brandId: ford.id,
    ...
    { slug: "toyota-hilux-adventure-2023", name: "Toyota Hilux Adventure 2023", year: 2023, trimName: "Adventure",
      imageUrl: BLOB("toyota-hilux-2023.jpg"), modelId: modelHilux.id, brandId: toyota.id,
      attributes: { fuel_type: "DIESEL", body_type: "pickup", payload_kg: 1080, engine_cc: 2755, power_hp: 204,
        torque_nm: 500, four_wd: true, tow_capacity_kg: 3500, tank_l: 80 } },
    { slug: "volkswagen-amarok-panamericana-2023", name: "Volkswagen Amarok PanAmericana 2023", year: 2023, trimName: "PanAmericana",
      imageUrl: BLOB("vw-amarok-2023.jpg"), modelId: modelAmarok.id, brandId: volkswagen.id,
    ...
    { slug: "isuzu-d-max-v-cross-2023", name: "Isuzu D-Max V-Cross 2023", year: 2023, trimName: "V-Cross",
      imageUrl: BLOB("isuzu-d-max-2023.jpg"), modelId: modelDMax.id, brandId: isuzu.id,
    ...
    { slug: "mitsubishi-l200-athlete-2023", name: "Mitsubishi L200 Athlete 2023", year: 2023, trimName: "Athlete",
      imageUrl: BLOB("mitsubishi-l200-2023.jpg"), modelId: modelL200.id, brandId: mitsubishi.id,
  ...
  const ebisikletProducts = [
    { slug: "trek-allant-7-2023", name: "Trek Allant+ 7 2023", year: 2023, trimName: null,
      imageUrl: "https://zy8lv1ozr05tdbmz.public.blob.vercel-storage.com/product-images/trek-allant-7-2023.jpg",
    ...
    { slug: "specialized-turbo-vado-5-0-igh-eq-2023", name: "Specialized Turbo Vado 5.0 IGH EQ 2023", year: 2023, trimName: "5.0 IGH EQ",
      imageUrl: "https://zy8lv1ozr05tdbmz.public.blob.vercel-storage.com/product-images/specialized-turbo-vado-5-2023.jpg",
    ...
    { slug: "giant-explore-e-3-gts-2023", name: "Giant Explore E+ 3 GTS 2023", year: 2023, trimName: "3 GTS",
      imageUrl: "https://zy8lv1ozr05tdbmz.public.blob.vercel-storage.com/product-images/giant-explore-e-plus-3-2023.jpg",
      modelId: modelGiantExplore.id, brandId: giant.id,
      attributes: { bike_type: "sehir", motor_type: "mid-drive", pedelec_class: "standard-25",
        motor_watt: 250, battery_wh: 500, range_km: 100, max_speed_kmh: 25, weight_kg: 24.5 } },
    { slug: "cube-kathmandu-hybrid-pro-500-2023", name: "Cube Kathmandu Hybrid Pro 500 2023", year: 2023, trimName: "Pro 500",
      imageUrl: "https://zy8lv1ozr05tdbmz.public.blob.vercel-storage.com/product-images/cube-kathmandu-hybrid-pro-2023.jpg",
    ...
    { slug: "engwe-engine-pro-2023", name: "Engwe Engine Pro 2023", year: 2023, trimName: null,
      imageUrl: "https://zy8lv1ozr05tdbmz.public.blob.vercel-storage.com/product-images/engwe-engine-pro-2023.jpg",
  ...
  const trendData = [
    { slug: "togg-t10x-uzun-menzil-2024",           viewCount: 2840, weeklyViewCount: 312 },
    { slug: "ford-ranger-raptor-2024",          viewCount: 2210, weeklyViewCount: 247 },
    { slug: "yamaha-mt-07-2023",          viewCount: 1870, weeklyViewCount: 198 },
    { slug: "tesla-model-y-long-range-rwd-2024",        viewCount: 1650, weeklyViewCount: 183 },
    { slug: "xiaomi-mi-electric-scooter-4-pro-2023",      viewCount: 1420, weeklyViewCount: 154 },
    { slug: "toyota-hilux-adventure-2023",         viewCount: 1380, weeklyViewCount: 141 },
    { slug: "kawasaki-ninja-400-2023",   viewCount: 1200, weeklyViewCount: 128 },
    { slug: "dacia-duster-extreme-2024",         viewCount: 1090, weeklyViewCount: 117 },
    { slug: "knaus-sky-i-2023",         viewCount:  880, weeklyViewCount:  89 },
    { slug: "zero-motorcycles-sr-s-premium-2024",            viewCount:  760, weeklyViewCount:  74 },
  ];

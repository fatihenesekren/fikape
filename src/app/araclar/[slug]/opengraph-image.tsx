    ...
    >
      ...
      <div style={{ display: "flex", alignItems: "center", gap: "13px" }}>
        ...
        <div style={{ display: "flex", alignItems: "baseline", gap: "2px" }}>
          <span style={{ fontSize: 32, fontWeight: 900, color: FIKAPE_SOFT.fi }}>fi</span>
          <span style={{ fontSize: 32, fontWeight: 300, color: "#333", margin: "0 3px" }}>·</span>
          <span style={{ fontSize: 32, fontWeight: 900, color: FIKAPE_SOFT.ka }}>ka</span>
          <span style={{ fontSize: 32, fontWeight: 300, color: "#333", margin: "0 3px" }}>·</span>
          <span style={{ fontSize: 32, fontWeight: 900, color: FIKAPE_SOFT.pe }}>pe</span>
        </div>
      </div>
      ...
      >
        ...
        {hasScores && (
          ...
          >
            <ScoreBar label="Fiyat"      score={fi} color={FIKAPE_SOFT.fi} />
            <ScoreBar label="Kalite"     score={ka} color={FIKAPE_SOFT.ka} />
            <ScoreBar label="Performans" score={pe} color={FIKAPE_SOFT.pe} />
          </div>
        )}
      </div>

...
// Ayarlar linkindeki dişli ikonu — sitenin diğer inline SVG ikon
// deseniyle (usta-gorusu/page.tsx GearIcon) aynı stil.
    ...
    <div className="max-w-2xl mx-auto px-4 py-10">
      ...
      <div className="flex flex-wrap items-center justify-between gap-x-3 gap-y-1 text-xs font-semibold text-gray-500 mb-6">
        ...
        {/* Kendi profiline bakan aktif usta zaten ne olduğunu biliyor —
            ...
            (kullanıcı fark etti). Sağdaki boşluğa onun yerine kendi
            profil ayarlarına giden bir kısayol geldi (kullanıcı isteği) —
            diğer kullanıcılar bu linki hiç görmez. */}
        {isOwnProfile ? (
          <Link href="/usta-gorusu/profil" className="inline-flex items-center gap-1 hover:text-gray-800 transition-colors min-w-0 truncate">

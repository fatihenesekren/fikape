...
const QUALITY_RUBRIC: Record<0 | 1 | 2, string> = {
  0: "Kurallara uyumlu ama sığ/jenerik — özgün, model'e özgü bilgi yok",
  1: "Spesifik ve model-doğru, kullanıcıya gerçek fayda sağlıyor (standart onay)",
  2: "İstisnai derinlik — doğrulanabilir, ayrıntılı, öne çıkan bir not",
};
  ...
  if (mode === "approve") {
    return (
      <div className="flex flex-col gap-1.5">
        ...
        {/* Rubrik önceden hiçbir yerde görünmüyordu, yalnız kod yorumundaydı
            (admin fark etti: "kalite puanını anlayamadım"). Seçili puanın
            açıklaması burada, tooltip'e ek olarak her zaman okunabilir. */}
        <p className="text-[11px] text-gray-400">{quality} — {QUALITY_RUBRIC[quality]}</p>

  ...
  await prisma.$transaction([
    prisma.tradeListing.update({
      ...
      data: {
        ...
        wantYearMin: data.wantYearMin ?? null,
        wantYearMax: data.wantYearMax ?? null,
        wantKmMin: data.wantKmMin ?? null,
        wantKmMax: data.wantKmMax ?? null,
        ...(data.wantFuelTypes !== undefined ? { wantFuelTypes: data.wantFuelTypes } : {}),
        ...(data.wantTransmissions !== undefined ? { wantTransmissions: data.wantTransmissions } : {}),
        note: data.note ?? null,
